...
export default async function (env: { watch?: boolean, production?: boolean, measure?: boolean } = {}) {
  ...
  function cssLoader(importLoaders = 1) {
    return {
      loader: 'css-loader',
  ...
  const config: import('webpack').Configuration = {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.styl$/,
          use: [extractCssLoader(), cssLoader(2), postcssLoader(), stylusLoader()],
        },
        {
          test: /\.scss$/,
          use: [extractCssLoader(), cssLoader(2), postcssLoader(), scssLoader()],
        },
        {
          test: /\.css$/,
